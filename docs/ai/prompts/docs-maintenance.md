...
- Do not add authorship or attribution markers — `Co-authored-by`, "generated by",
  tool or vendor credits, emoji sign-offs — to any file, commit message, or
  summary. This bans *attribution*, not the *subject*: where the repository
  legitimately documents AI tooling (`docs/ai/**`, agent prompts, model
  configuration), document it accurately like any other subsystem.
